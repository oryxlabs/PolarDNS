...
runtest "cgena.4.${domain}" "d63e355d40dd4e5e1cd591387d99ed04"
runtest "cgena.5.${domain}" "5007464245b75e4ca776f901ee366c45"
runtest "cgena.6.${domain}" "612813e256fafa11ea7a31038bdd206c"
...
runtest "cgena.4.46.2.${domain}" "d14f6d05ddec18b8efe90ee89b3846c4"
runtest "cgena.5.46.2.${domain}" "24c282795ecb3303185ca5547239b7a8"
runtest "cgena.6.46.2.${domain}" "d7cd3309429d0aa15c50e24bfb2acfd0"
...
runtest "cgena.4.46.20.${domain}" "9441c6c2b41d95ac3209881c818052c1"
runtest "cgena.5.46.20.${domain}" "f8e7fb597316aad414b87c8eacdaf0a7"
runtest "cgena.6.46.20.${domain}" "5402d9a880d1b673002fe007a7a50fd7"
...
runtest "cgenb.4.${domain}" "e5cd322bceccc4db375c8d87cc87a202"
runtest "cgenb.5.${domain}" "fffba26dd72d93cf0e7fe7287a168978"
runtest "cgenb.6.${domain}" "4da8b5f7b2e49705243db52c6fda725f"
...
runtest "cgenb.4.46.2.${domain}" "64260c024c2ff8f73ad4f8d6b2246466"
runtest "cgenb.5.46.2.${domain}" "ac8dee69d592e08c81a28ae3455d7bf5"
runtest "cgenb.6.46.2.${domain}" "07f3115d4ecc3caa689036d9674c9c1a"
...
runtest "cgenb.4.46.20.${domain}" "81603b6878e3ecb022731b7de5080bc9"
runtest "cgenb.5.46.20.${domain}" "3073318f349fb89d11e9d377b32a98d2"
runtest "cgenb.6.46.20.${domain}" "6e25413e890d379efa21c575a2bb2063"
...
runtest "cgenb.4.255.10.${domain}" "a5a79a94bcbbebd1efcb0fcbc98287f8"
runtest "cgenb.5.255.10.${domain}" "02880fe7abb7db80c18bf55b5cdf25c2"
runtest "cgenb.6.255.10.${domain}" "64d9b1565d2bb622f7fa0c90715f9430"
...
runtest "cgenb.4.0.10.${domain}" "4c6c99b75545675302c6cf805b5a607a"
runtest "cgenb.5.0.10.${domain}" "9b219d9911907d7f5377d04782595988"
runtest "cgenb.6.0.10.${domain}" "b8bc4d177f23a4861267eac0b783fb00"
