...
rundig() {
  ...
  | sed -E 's/(SRV\s*0\s*0\s*)[0-9]*\s*(sr|)(loop|chain|alias)/\1 <PORT> \2\3/g' \
...
runtest "alias.10.nfz4.10.${domain}" "51894e3b825e8ac3ca3d4aae800c9c0e"
runtest "alias.10.nfz5.10.${domain}" "c3f8f5d4f91ea27df075875e46516aec"
runtest "alias.10.nfz12.10.${domain}" "925700625de2df2f14324bf099b14e17"
runtest "alias.10.nfz13.10.${domain}" "b3878a633d5e9817da8a5c5b38724925"
runtest "alias.10.nfz14.10.${domain}" "674173e8d1b52cd694677b29cb45244f"
runtest "alias.10.nfz17.10.${domain}" "ff533972feea0aaaf3e192d92fc90b29"
runtest "alias.10.nfz18.10.${domain}" "149955ecda7096bf2622b8a84e2411d4"
runtest "alias.10.nfz22.10.${domain}" "29d10a8e6ef7f0def1aeb33190927182"
runtest "alias.10.nfz23.10.${domain}" "1a53114a31444ab75105d3afcfb89152"
runtest "alias.10.nfz24.10.${domain}" "b3339a076c9d9e9c3ab0a683f7d93c7f"
runtest "alias.10.nfz27.10.${domain}" "587d015d6f7906207205e93190ed788e"
runtest "alias.10.nfz28.10.${domain}" "a3a3cec6f0e9bc605a17ebdaac6147bb"
runtest "alias.10.nfz29.10.${domain}" "7bf5dab536b47034b1bac66b6e2c2bc3"
runtest "alias.10.nfz32.10.${domain}" "2e6dcc0a35076c65eed93d5f6556e26e"
runtest "alias.10.nfz33.10.${domain}" "4ea015d380cd32198d90ddaa21f69be6"
runtest "alias.10.nfz34.10.${domain}" "c0cd9a0b9f08acd9f7396f63202f4d6f"
runtest "alias.10.nfz35.10.${domain}" "86f37fbf73818350035317e904621eb0"
runtest "alias.10.nfz36.10.${domain}" "e4b8253776961316645f0250711d6a81"
runtest "alias.10.nfz37.10.${domain}" "241c635f71f9c595bb9a634b8bd56288"
...
runtest "alias.10.nfz40.10.${domain}" "440bd03f82d3b2e43f9c7f1ed50dadb5"
runtest "alias.10.nfz41.10.${domain}" "b21e232b4666929d25db8d18fe554f19"
runtest "alias.10.nfz42.10.${domain}" "b5002b1de8c716fc36cb075c941b8fd9"
runtest "alias.10.nfz43.10.${domain}" "28f898e6ccc29918a415629c7704e5cc"
...
runtest "MX alias.20.nfz4.20.${domain}" "3494ba36c62ee0d1a45fe70d8d3948ef"
runtest "MX alias.20.nfz5.20.${domain}" "a2013f9a6be9a11df5423df43d564bbf"
runtest "MX alias.20.nfz12.20.${domain}" "849d73f30172c706124944210dc3afc1"
runtest "MX alias.20.nfz13.20.${domain}" "1366394f04e8d7c7e1bf5e2784a43591"
runtest "MX alias.20.nfz14.20.${domain}" "592cad73718987e0fb0f379f43a971c2"
runtest "MX alias.20.nfz17.20.${domain}" "dac235bfb3d44f532aafb91f07c05320"
runtest "MX alias.20.nfz18.20.${domain}" "a03bb12b70005aaee6a3adcd52211f5a"
runtest "MX alias.20.nfz22.20.${domain}" "faf9d49f517f57dedaf732f7b769b6e0"
runtest "MX alias.20.nfz23.20.${domain}" "f3b8de4369317db6ab33217f467cd081"
runtest "MX alias.20.nfz24.20.${domain}" "c4514acd4d9489c516c73f017db5d1d7"
runtest "MX alias.20.nfz27.20.${domain}" "acf8eb592550f1085a564e1b8bbf1026"
runtest "MX alias.20.nfz28.20.${domain}" "7d342ee64c0d686ea236932334d34f9d"
runtest "MX alias.20.nfz29.20.${domain}" "05e40a32f009cfd5b41862361b7a5175"
runtest "MX alias.20.nfz32.20.${domain}" "5d1b603a62f3966ccefb0152d57ea820"
runtest "MX alias.20.nfz33.20.${domain}" "369ca3684e58a66aec57086d8cdca752"
runtest "MX alias.20.nfz34.20.${domain}" "fa61fdfdea451b78766b60a063f451e0"
runtest "MX alias.20.nfz35.20.${domain}" "a7ded95bf92993f583c6d3e5d730217f"
runtest "MX alias.20.nfz36.20.${domain}" "4be3e13a8c391d435ec4e1f21a20a3cd"
runtest "MX alias.20.nfz37.20.${domain}" "c9864643390dc1dcc5b31f667fc8b3a4"
...
runtest "MX alias.20.nfz40.20.${domain}" "af4df533c0bfc43a29a1c2dc442efda6"
runtest "MX alias.20.nfz41.20.${domain}" "b541af438b183f1350b2cc00aee22e95"
runtest "MX alias.20.nfz42.20.${domain}" "9109243a0b9ee243bb060659c6cb9729"
runtest "MX alias.20.nfz43.20.${domain}" "4458be54678e7f6e62c7107df74a9260"
...
runtest "HTTPS alias.30.nfz4.20.${domain}" "768595a79af89f13dd2c32adc71eb279"
runtest "HTTPS alias.30.nfz5.20.${domain}" "4ec31b04688159d3a2c0873a85f99d37"
runtest "HTTPS alias.30.nfz12.20.${domain}" "e4e80c145bbf4d175532a8ef68f4c00f"
runtest "HTTPS alias.30.nfz13.20.${domain}" "47fbd56b7d8cbab3ed131dbf527afab3"
runtest "HTTPS alias.30.nfz14.20.${domain}" "7fb88033cccdd7eba98106317601a653"
runtest "HTTPS alias.30.nfz17.20.${domain}" "d224941257ac9640cd4104aa5a438c6c"
runtest "HTTPS alias.30.nfz18.20.${domain}" "61682f305cca23ff320b7277a782fdee"
runtest "HTTPS alias.30.nfz22.20.${domain}" "e819af16f0e00254232a12b2c7a33e0d"
runtest "HTTPS alias.30.nfz23.20.${domain}" "168bbc3f17710ad6682424eb3c9d4ce4"
runtest "HTTPS alias.30.nfz24.20.${domain}" "2d3f588f7988df2043fa2b4382350bdd"
runtest "HTTPS alias.30.nfz27.20.${domain}" "634b7cfb4b8f397b0cfad24c20694d02"
runtest "HTTPS alias.30.nfz28.20.${domain}" "3e79e9fcb09632ab7acd68696b470aa2"
runtest "HTTPS alias.30.nfz29.20.${domain}" "6bf5a671222a8450a33a2beda0b5fd37"
runtest "HTTPS alias.30.nfz32.20.${domain}" "9213d8b2639e4f6267436250cb76b064"
runtest "HTTPS alias.30.nfz33.20.${domain}" "7c2dddbeb7e0a6e21780c4d522c46f11"
runtest "HTTPS alias.30.nfz34.20.${domain}" "620d023214cfe866efb27d087b2e9112"
runtest "HTTPS alias.30.nfz35.20.${domain}" "ec4c93a853d365d9fbc12e098dd41563"
runtest "HTTPS alias.30.nfz36.20.${domain}" "5634a5325d77226aecd455040526e2f7"
runtest "HTTPS alias.30.nfz37.20.${domain}" "e8ca3c15fd23e4f43c2e8f4675553665"
...
runtest "HTTPS alias.30.nfz40.20.${domain}" "f5808fc6f0379e2b4e46501da6576b4a"
runtest "HTTPS alias.30.nfz41.20.${domain}" "247fe8fe6c55fa1be98f1c7bfe5a3238"
runtest "HTTPS alias.30.nfz42.20.${domain}" "f4ebe12457ce327f3ff002c5a38338bc"
runtest "HTTPS alias.30.nfz43.20.${domain}" "d774006659fe3bcb45f856cf975448e4"
...
runtest "DNAME alias.40.nfz4.20.${domain}" "8ff37d05c4dbe09b3ff547ccd6b73185"
runtest "DNAME alias.40.nfz5.20.${domain}" "2c0affae083923d433e340ad866bc92f"
runtest "DNAME alias.40.nfz12.20.${domain}" "332ed11adcfc6da5461af695eece5c79"
runtest "DNAME alias.40.nfz13.20.${domain}" "9064b9de00c478d5ef0ac4508c6d1252"
runtest "DNAME alias.40.nfz14.20.${domain}" "0aaa678cf4e7d651ffa38d97d7d89949"
runtest "DNAME alias.40.nfz17.20.${domain}" "439e0f469c3eb0b644b9231df39ab1b4"
runtest "DNAME alias.40.nfz18.20.${domain}" "9b80573f7828839b1e5dedd396370087"
runtest "DNAME alias.40.nfz22.20.${domain}" "78d54c10efab60ee0361e3d951f0473a"
runtest "DNAME alias.40.nfz23.20.${domain}" "58374ccaa8b604c30cf00677b058d60a"
runtest "DNAME alias.40.nfz24.20.${domain}" "cb507ef036867fdfe39c633e637d168d"
runtest "DNAME alias.40.nfz28.20.${domain}" "346fdc08ab0e5abc98632db2574fc227"
runtest "DNAME alias.40.nfz29.20.${domain}" "6fee49899249414a741bf3183bdc6a0c"
runtest "DNAME alias.40.nfz32.20.${domain}" "35edd72bb9133a50ae2ffcc3c082261d"
runtest "DNAME alias.40.nfz33.20.${domain}" "23b30d41e86f9b89176200cc7f616587"
runtest "DNAME alias.40.nfz34.20.${domain}" "e3e0ac9df8e4726373013610af290bc1"
runtest "DNAME alias.40.nfz35.20.${domain}" "c92eb5483dc18fac5c1dc118eef41cd6"
runtest "DNAME alias.40.nfz36.20.${domain}" "f5d2bf3510d4891561f0c5f4c1cd29ca"
runtest "DNAME alias.40.nfz37.20.${domain}" "35c6641e4bc2196c2ca2d883b91fac99"
...
runtest "DNAME alias.40.nfz40.20.${domain}" "0e2766dc47bc7805fba70a89c2cb6352"
runtest "DNAME alias.40.nfz41.20.${domain}" "9eac0cf1afee50292ecf6f14104ec9a2"
runtest "DNAME alias.40.nfz42.20.${domain}" "9b817b4740744c43c97b8a282c5048d7"
runtest "DNAME alias.40.nfz43.20.${domain}" "332a3cb773961bd0d5742ecde71a5a99"
